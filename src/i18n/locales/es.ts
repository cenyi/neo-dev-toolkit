export const es = {
  translation: {
    ...
    home: {
      ...
      subtitle: 'Herramientas de desarrollo profesionales con diseño neumórfico moderno',
      description: 'Una colección completa de herramientas esenciales para desarrolladores que incluye formato JSON, procesamiento de texto, encriptación y más.'
    },
    tools: {
      json: {
    ...
    footer: {
      ...
      description: 'Tu "navaja suiza" todo en uno para desarrollo. Con herramientas para JSON, texto, encriptación y más para optimizar tu flujo de trabajo.',
      vercel: 'Vercel',
      github: 'GitHub',
      deepseek: 'DeepSeek'
    },
    about: {
      ...
      missionText: 'Nuestra misión es proporcionar a los desarrolladores un conjunto de herramientas integral, fácil de usar y potente que actúe como una "navaja suiza" para sus tareas diarias. Nuestro objetivo es crear una tienda única para utilidades de desarrollo, haciendo que los flujos de trabajo sean más eficientes y agradables para todos.',
