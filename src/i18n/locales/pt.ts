export const pt = {
  "translation": {
    ...
    "home": {
      ...
      "subtitle": "Ferramentas de desenvolvimento profissionais",
      "description": "Uma coleção abrangente de ferramentas essenciais para desenvolvedores, incluindo formatação JSON, processamento de texto, criptografia e muito mais. Otimizado para desempenho.",
      "headerTitle": "Hub Gratuito de Ferramentas para Desenvolvedores Online",
      ...
      "feature3Description": "Design limpo e responsivo que funciona perfeitamente em todos os dispositivos",
